      ...
      <div className="max-w-7xl mx-auto px-4 py-6 space-y-5">
        ...
        {!loading && displayed.length > 0 && (
          <div className="flex gap-4 flex-wrap">
            <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-lg px-4 py-2.5 flex items-center gap-2">
        ...
        {/* ── Filters Panel ── */}
        <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-lg p-4 space-y-3">
            ...
            <div className="flex gap-1 ml-auto">
              <button
                ...
                className={`px-3 py-2 text-xs rounded-lg border transition-all font-medium ${
                  sortKey === "changePercent" && sortDir === "desc"
              ...
              <button
                ...
                className={`px-3 py-2 text-xs rounded-lg border transition-all font-medium ${
                  sortKey === "changePercent" && sortDir === "asc"
                    ? "bg-blue-50 border-blue-200 text-blue-700 dark:bg-blue-900/30 dark:border-blue-800 dark:text-blue-400"
                    : "bg-gray-50 border-gray-200 text-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 hover:border-gray-300"
                }`}
              >
        ...
        {/* ── Content ── */}
        {loading || perfLoading ? (
          <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-lg p-12 flex flex-col items-center gap-3">
          ...
          <div className="bg-white dark:bg-gray-900 border border-red-100 dark:border-red-900/40 rounded-lg p-8 text-center text-red-600 dark:text-red-400 text-sm">
            {error}
          </div>
        ) : (

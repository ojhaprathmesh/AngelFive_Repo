...
export default function ChartComponent({
    ...
    const IconPatternXABCD = (props: React.SVGProps<SVGSVGElement>) => (
        ...
        >
            ...
            <path
                d="M4.5 15.5 L8.5 7.5 L12.5 13.5 L16.5 6.5 L20.5 14.5"
                stroke="currentColor"
                strokeWidth="1.5"
                strokeLinecap="round"
            />
            <path
                d="M4.5 15.5 L12.5 13.5 M8.5 7.5 L20.5 14.5"
                stroke="currentColor"
                strokeWidth="1.2"
                strokeLinecap="round"
            />
    ...
    const IconPatternABCD = (props: React.SVGProps<SVGSVGElement>) => (
        ...
        >
            ...
            <path
                d="M6 7.5 L18 7.5 L18 16.5 L6 16.5 Z"
                stroke="currentColor"
                strokeWidth="1.5"
            />
    ...
    const patternIcon = () =>
        tool === "abcd" ? <IconPatternABCD /> : <IconPatternXABCD />;
    const paintIcon = () =>
        tool === "highlighter" ? (
    ...
    useEffect(() => {
        ...
        const down = (e: MouseEvent) => {
            ...
            if (
                ...
                drawing = true;
                current = {
                    type: tool as "brush" | "highlighter",
                    path: [p],
                    size: tool === "brush" ? 2 : 8,
                };
            }
        ...
        <div className="h-full">
            <div className="flex flex-col h-full gap-3">
                ...
                <div className="flex flex-1 min-h-0">
                    <div
                        className="flex flex-col items-center gap-2 pr-2 border-r"
                        role="toolbar"
                    ...
                    >
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <Button
                                    variant={isGroupSelected(pointerGroup) ? "default" : "ghost"}
                                    size="icon-sm"
                                    className="relative"
                                ...
                                >
                                    {pointerIcon()}
                                    <span
                                        className="absolute -bottom-0.5 -right-0.5 h-1.5 w-1.5 rounded-full bg-muted-foreground" />
                                </Button>
                            </DropdownMenuTrigger>
                            <DropdownMenuContent side="right">
                                <DropdownMenuLabel>Pointer</DropdownMenuLabel>
                                <DropdownMenuItem onClick={() => setTool("pointer-cross")}>
                                    <Crosshair className="h-4 w-4" /> Cross
                                </DropdownMenuItem>
                                <DropdownMenuItem onClick={() => setTool("pointer-dot")}>
                                    <MousePointer2 className="h-4 w-4" /> Dot
                                </DropdownMenuItem>
                            </DropdownMenuContent>
                        </DropdownMenu>
                        ...
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <Button
                                    variant={isGroupSelected(lineGroup) ? "default" : "ghost"}
                                    size="icon-sm"
                                    className="relative"
                            ...
                            <DropdownMenuContent side="right">
                                ...
                                <DropdownMenuItem onClick={() => setTool("info")}>
                                    <IconInfoLine /> Infoline
                                </DropdownMenuItem>
                            </DropdownMenuContent>
                        </DropdownMenu>
                        ...
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <Button
                                    variant={isGroupSelected(patternGroup) ? "default" : "ghost"}
                                    size="icon-sm"
                                    className="relative"
                            ...
                            <DropdownMenuContent side="right">
                                ...
                                <DropdownMenuItem onClick={() => setTool("xabcd")}>
                                    <IconPatternXABCD /> XABCD
                                </DropdownMenuItem>
                                <DropdownMenuItem onClick={() => setTool("abcd")}>
                                    <IconPatternABCD /> ABCD
                                </DropdownMenuItem>
                            </DropdownMenuContent>
                        </DropdownMenu>
                        ...
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <Button
                                    variant={isGroupSelected(paintGroup) ? "default" : "ghost"}
                                    size="icon-sm"
                                    className="relative"
                            ...
                            <DropdownMenuContent side="right">
                                ...
                                <DropdownMenuItem onClick={() => setTool("brush")}>
                                    <Brush className="h-4 w-4" /> Brush
                                </DropdownMenuItem>
                                <DropdownMenuItem onClick={() => setTool("highlighter")}>
                                    <Highlighter className="h-4 w-4" /> Highlighter
                                </DropdownMenuItem>
                            </DropdownMenuContent>
                        </DropdownMenu>
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent side="right">
                                ...
                                <DropdownMenuItem onClick={doZoomIn}>
                                    <ZoomIn className="h-4 w-4" /> Zoom In
                                </DropdownMenuItem>
                                <DropdownMenuItem onClick={doZoomOut}>
                                    <ZoomOut className="h-4 w-4" /> Zoom Out
                                </DropdownMenuItem>
                                <DropdownMenuItem onClick={doFit}>
                                    <ZoomOut className="h-4 w-4" /> Fit
                                </DropdownMenuItem>
                            </DropdownMenuContent>
                        </DropdownMenu>
                    </div>
                    ...
                    <div
                        className="flex-1 relative rounded-md border bg-gray-50 dark:bg-gray-900 overflow-hidden min-h-100">
                        <div
                            ref={rootRef}

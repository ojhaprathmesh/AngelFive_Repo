                                ...
                                <TabsContent value="models" className="space-y-4">
                                    <Card>
                                        ...
                                        <CardContent className="space-y-4">
                                            ...
                                            {arimaResult && (
                                                <div
                                                    className="mt-4 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg space-y-2">
                                    ...
                                    <Card>
                                        ...
                                        <CardContent className="space-y-4">
                                            ...
                                            {garchResult && (
                                                <div
                                                    className="mt-4 p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg space-y-2">
                                ...
                                <TabsContent value="lstm" className="space-y-4">
                                    <Card>
                                        ...
                                        <CardContent className="space-y-4">
                                            ...
                                            {lstmResult && (
                                                <div
                                                    className="mt-4 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg space-y-2">
                                ...
                                <TabsContent value="sentiment" className="space-y-4">
                                    <Card>
                                        ...
                                        <CardContent className="space-y-6">
                                            <div>
                                                <label
                                                    className="text-sm font-semibold mb-3 block text-gray-700 dark:text-gray-300">
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                {finbertResult && (
                                                    <div
                                                        className="rounded-xl border-2 border-blue-200 dark:border-blue-800 bg-linear-to-br from-blue-50 to-white dark:from-blue-900/20 dark:to-gray-900 p-5 shadow-sm">
                                                        ...
                                                        <div className="space-y-3">
                                                            <div
                                                                ...
                                                                <span
                                                                    className="text-lg font-bold font-mono text-gray-900 dark:text-white">
                                                ...
                                                {ruleSentimentResult && (
                                                    <div
                                                        className="rounded-xl border-2 border-purple-200 dark:border-purple-800 bg-linear-to-br from-purple-50 to-white dark:from-purple-900/20 dark:to-gray-900 p-5 shadow-sm">
                                                        <div className="flex items-center justify-between mb-4">
                                ...
                                <div className="space-y-4">
                                    {error.includes("SmartAPI credentials not configured") ? (
                                        <Card className="border-yellow-200 bg-yellow-50 dark:bg-yellow-900/20">
                                            <CardHeader>
                                                <CardTitle
                                                    className="text-yellow-800 dark:text-yellow-200 flex items-center gap-2">
                                            ...
                                            <CardContent className="text-left space-y-3">
                                                ...
                                                <div
                                                    className="bg-white dark:bg-gray-800 p-3 rounded text-xs font-mono space-y-1">

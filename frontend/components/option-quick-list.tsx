...
export function OptionQuickList({ isOpen, onClose }: OptionQuickListProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center p-0 sm:p-4 pointer-events-none">
      <div className="bg-white dark:bg-gray-900 w-full max-w-4xl h-[80vh] sm:h-150 rounded-t-xl sm:rounded-xl shadow-2xl border border-gray-200 dark:border-gray-800 flex flex-col pointer-events-auto">
        {/* Header */}
          ...
          <div className="flex items-center gap-6">
            {(["NIFTY", "BANKNIFTY", "FINNIFTY"] as const).map((tab) => (
              <button
                ...
                className={`text-sm font-medium transition-colors relative pb-2 -mb-3.25 ${
                  selectedTab === tab
    ...
    <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-3 hover:shadow-sm transition-shadow cursor-pointer group">
      ...
      <div className="flex items-center justify-between text-xs">
        <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
          <button className="bg-green-600 hover:bg-green-700 text-white px-3 py-0.5 rounded text-[10px] font-medium">
            B
          </button>
          <button className="bg-red-600 hover:bg-red-700 text-white px-3 py-0.5 rounded text-[10px] font-medium">
            S
          </button>
        </div>
        <div

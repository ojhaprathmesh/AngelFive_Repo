...
export function TradingChart() {
    ...
    return (
        <div
            className="space-y-6 w-full p-4 bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
            {/* Header */}
                        ...
                        return (
                            <React.Fragment key={index}>
                                <button
                                    ...
                                    className={`group w-full px-3 py-2 transition-colors hover:bg-gray-50 dark:hover:bg-gray-700 border-b-2 ${isActive ? "border-b-blue-500" : "border-b-transparent"
                                        } ${i !== 0 ? "border-l border-l-gray-200 dark:border-l-gray-700" : ""} ${i === 0 && isActive ? "rounded-tl-lg" : ""
                                        } ${i === indices.length - 1 && isActive ? "rounded-tr-lg" : ""}`}
                                >
                                    <div
                                        className="text-xs font-medium text-gray-500 dark:text-gray-400 text-left truncate max-w-25">
                                        {index}
                                    </div>
                                    <div className="flex items-center gap-1.5">
                                        ...
                                        <div className="flex items-center gap-1">
                                            ...
                                            <span
                                                className={`text-xs font-medium ${isPositiveChange ? "text-green-700" : "text-red-700"
                                                    }`}
                                            >
                                                {isPositiveChange ? "+" : ""}
                        ...
                        <div className="p-3" style={{ zIndex: 1 }}>
                            ...
                            <div className="space-y-3">
                                <div className="relative">
                                    <div
                                        className="w-full h-1.5 bg-linear-to-r from-[#d64d4d] to-[#029076] rounded-full"></div>
                                    <div
                                ...
                                <div
                                    className="flex items-center justify-between text-xs font-medium text-gray-700 dark:text-gray-300">
                                ...
                                <div
                                    className="grid grid-cols-4 gap-0 divide-x divide-custom divide-dotted text-[12px] font-medium">
                                    <div className="flex flex-col pr-3">
                                        <div className="text-xs text-gray-500 dark:text-gray-400 mb-1">
                                            Open
                                        </div>
                                        <div
                                            className="text-sm font-numbers numeric-tabular text-gray-900 dark:text-white font-semibold">
                                    ...
                                    <div className="flex flex-col px-3">
                                        ...
                                        <div
                                            className="text-sm font-numbers numeric-tabular text-green-600 dark:text-green-400 font-semibold">
                                    ...
                                    <div className="flex flex-col px-3">
                                        ...
                                        <div
                                            className="text-sm font-numbers numeric-tabular text-red-600 dark:text-red-400 font-semibold">

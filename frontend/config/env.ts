...
export const ENV: Env = {
    ...
    // Firebase Config
    FIREBASE_API_KEY: requiredEnv("NEXT_PUBLIC_FIREBASE_API_KEY"),
    FIREBASE_AUTH_DOMAIN: requiredEnv("NEXT_PUBLIC_FIREBASE_AUTH_DOMAIN"),
    FIREBASE_PROJECT_ID: requiredEnv("NEXT_PUBLIC_FIREBASE_PROJECT_ID"),
    FIREBASE_STORAGE_BUCKET: requiredEnv("NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET"),
    FIREBASE_MESSAGING_SENDER_ID: requiredEnv("NEXT_PUBLIC_FIREBASE_MESSAGING_SENDER_ID"),
    FIREBASE_APP_ID: requiredEnv("NEXT_PUBLIC_FIREBASE_APP_ID"),
